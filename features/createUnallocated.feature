Feature: Create Unalocated Shipment

    Scenario:Create Unallocated
    ...
    Scenario: Edit Unallocated
        ...
        Then The homepage should be displayed
        And User clicks on Shipments button
        And User clicks on Unallocated button
        And Selects the last entry and click Edit
